...
var site =  {
	...
	// Слайдер с брендами на главной странице
	__brandSlider: function () {
		if ($('.index-partners__slider').length) {
		...
		if ($('#contact-map').length) {
			...
			function initYM () {
			    var contactsMap = new ymaps.Map("contact-map", {
			            center: [61.76128206, 34.30615750],
			            behaviors: ['default'], // скроллинг колесом
			            zoom: 16,
			            controls: ['zoomControl']
			        });
			     contactsMap.geoObjects
			    	.add(new ymaps.Placemark([61.76128206, 34.30615750],{
			    		 balloonContent: ''
			    		},{
			    			iconLayout: 'default#image',
				            iconImageHref: '../img/stuff/marker.png',
				            iconImageSize: [73, 71],
